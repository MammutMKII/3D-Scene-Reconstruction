...
int a()
{
	...
	flipVertical = false;
	outputFilename = "D:/Projects/3D-Scene-Reconstruction/params.txt";
	...
	bool release_object = false; //=true;
...
void computeStereoCalibrationParams(Mat rawLeftChessboard, Mat rawRightChessboard, int &leftCalibrationParams, int &rightCalibrationParams) {
	...
	bool success = findChessboardCorners(rawLeftChessboard, Size(8, 8), corners);
	if (success) {
		InputOutputArray corners2{};
		cornerSubPix(rawLeftChessboard, corners2, Size(11, 11), Size(-1, -1), TermCriteria(1, 30, 0.001));
		//imgpoints.append(corners)
		//Draw and display the corners
		drawChessboardCorners(rawLeftChessboard, Size(8, 8), corners2, success);
		imshow("img", rawLeftChessboard);
		waitKey(500);
	}
	//a();
}